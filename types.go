...
const (
	...
	itemGoldHelmet        byte = 138
	itemGoldChestplate    byte = 139
	itemGoldLeggings      byte = 140
	itemGoldBoots         byte = 141
	itemIronHelmet        byte = 142
	itemIronChestplate    byte = 143
	itemIronLeggings      byte = 144
	itemIronBoots         byte = 145
	itemDiamondHelmet     byte = 146
	itemDiamondChestplate byte = 147
	itemDiamondLeggings   byte = 148
	itemDiamondBoots      byte = 149
	itemWoodSword         byte = 150
	itemStoneSword        byte = 151
	itemIronSword         byte = 152
