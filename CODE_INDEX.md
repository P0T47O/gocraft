...
| 生物 CPU 姿态、原生工作台与四怪显卡画廊 | [mob_pose.go](mob_pose.go)、[mob_preview_windows.go](mob_preview_windows.go)、[webgpu_workshop_windows.go](webgpu_workshop_windows.go)、[mob_workshop_windows_test.go](mob_workshop_windows_test.go)、[mob_gallery_windows_test.go](mob_gallery_windows_test.go)；设置 `GOCRAFT_WEBGPU_REGRESSION=1` |
