...
// the shape/icon HUD, text overlay, and inventory are encoded into one render
// pass so the Raylib/OpenGL presenter remains completely idle while StatePlaying
// owns the HWND through WebGPU.
